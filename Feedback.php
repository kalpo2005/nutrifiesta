...
<body  class="w-100" style="background:url('images/bg-img/11111.jpg')  " >
        ...
        <div class="container">
          <div class="row bg-light shadow my-5 px-2" style="background:url('images/bg-img/11111-2.jpg') ">
...
<div>
  <label class="form-label"><h4>User Experience</h4></label><br>

  <label class="form-label"><h5>1. How easy was it to navigate our website?</h5></label>
  <div class="form-check">
    <input class="form-check-input" type="checkbox" value="Very Easy" id="easy">
    <label class="form-check-label" for="easy">Very Easy</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="checkbox" value="Difficult" id="difficult">
    <label class="form-check-label" for="difficult">Difficult</label>
  </div>

  <label class="form-label"><h5>2. Was the content on our website clear and concise?</h5></label>
  <div class="form-check">
  ...
  <div class="col-md-6">
    ...
    <!-- Comments Section -->
<div class="mb-3">
  <label><h4>Oue Website</h4></label><br>
  <div class="form-check">
    <input class="form-check-input" type="checkbox" value="Very Easy" id="easy">
    <label class="form-check-label" for="easy">Good</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="checkbox" value="Very Easy" id="easy">
    <label class="form-check-label" for="easy">Not Good</label>
  </div>
</div>
</div>
...
<div style="display:flex; align-items:flex-start;">
  ...
  <textarea rows="4" cols="50" class="form-control" name="comments"></textarea>
</div>
...
<div class="col-md-7">
  ...
  <button type="submit" values="send Feedback" name="Add_To_Cart" class="btn btn-info">Submit</button>
  </div>
  <br>
</form>
